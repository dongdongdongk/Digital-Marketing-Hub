...
import { getAboutPageConfig, getUIText, getSiteInfo } from '@/lib/config'
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Mission Section */}
        <section className="mb-16">
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg p-8 md:p-12">
            ...
            {aboutConfig.team.members.map((member, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md border border-gray-100 p-6">
                <div className="text-center mb-4">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full flex items-center justify-center">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {member.expertise.map((skill, skillIndex) => (
                      <span key={skillIndex} className="px-2 py-1 bg-orange-100 text-orange-800 text-xs rounded-full">
                        {skill}
                      </span>
                    ))}
                  </div>
        ...
        <section className="text-center">
          <div className="bg-gradient-to-r from-gray-50 to-orange-50 rounded-lg p-8">
...
export const metadata: Metadata = generateSEOMetadata({
  title: 'About Easy Digital Marketing - Meet Our Expert Team',
  description: 'Learn about the experienced digital marketing professionals behind Easy Digital Marketing. Discover our mission, expertise, and proven track record.',
  url: '/about',
  type: 'website'
})